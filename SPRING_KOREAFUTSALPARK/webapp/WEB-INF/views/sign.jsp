...
<script type="text/javascript" src="js/signjs.js" charset="UTF-8"></script>
...
<link href="https://fonts.googleapis.com/css?family=Nanum+Gothic|Roboto+Condensed:700&display=swap" rel="stylesheet"><!-- font-family: 'Roboto Condensed', sans-serif;//font-family: 'Nanum Gothic', sans-serif; -->
<style>
input[type=button]{
font-weight:bold;
}
...
<script type="text/javascript">
	...
	function idCheck() {
		$.ajax({
			...
			success : function(ci){
				if(ci=="using"){
					$("#ajaxReturn").html("이미 사용중인 ID입니다");
					document.getElementById("ajaxReturn").style.color = "red";
					document.join.hidden.value = "0";
				}else{
					$("#ajaxReturn").html("사용 가능한 ID입니다");
					document.getElementById("ajaxReturn").style.color = "blue";
		...
		<section id="mainright">
			<div id="matList">
				<div class="container" id="formOutterWrapper">
					<center>
						<h1 style="font-weight:bold;font-size:50px;">JOIN US</h1>
					</center>
					<div class="container" id="formInnerWrapper">
						<form name="join" id="materialForm" class="form" method="post"
							action="signinput" role="form"
							autocomplete="off">
							...
							<div class="form-group">
								...
								<div class="col-xs-2">
									...
									<select name="mail" class=formInput
										onChange=mailaddr(this.value) style="width: 158px;">
							...
							<div class="form-group">
								...
								<div class="col-xs-2">
									<input type="button" value="우편번호 찾기" class="btn btn-default" style="font-weight:normal;"
							...
							<div class="form-group">
								...
								<div class="col-xs-1"
									style="font-size: 16px; font-weight: 400; width: 9px; margin-right:-15px;"></div>
								<div class="col-xs-2" style="width:215px;margin-top: 11px;">
							...
							<div class="form-group" style="">
								...
								<div class="col-xs-3"
									...
									<input type="button" value="가입" class="signbutton signbutton5"
										...
										onClick="script: location.href='sign'">
								</div>
							</div>
