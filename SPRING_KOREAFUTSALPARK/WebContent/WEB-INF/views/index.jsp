	...
	<div class="map_wrap">
		...
		<div id="menu_wrap" class="bg_white">
			<ul id="placesList">
				...
				<a href="javascript:void(0);" onclick="setcenter('<%=BranchList.get(i).getLOCATION()%>');">
					<li class="item"><span class="markerbg marker_<%=i%>"></span>
						<div class="info2">
							<h5><%=BranchList.get(i).getBRANCHNAME()%></h5>
							<span><%=BranchList.get(i).getLOCATION()%></span> <span class="tel"><%=BranchList.get(i).getTEL()%></span>
						</div></li>
				</a>
				<%} %>
			</ul>
...
<% for(int i=0; i<BranchList.size(); i++){ %>
      {content: '<div class="wrap">' + 
		     '    <div class="info">' + 
		     '        <div class="title">' + 
		     '            <%=BranchList.get(i).getBRANCHNAME()%>' + 
		     '        </div>' + 
		     '        <div class="body">' + 
		     '            <div class="img">' +
		     '                <img src="img/<%=BranchList.get(i).getPIC()%>" width="73" height="70">' +
		     '           </div>' + 
		     '            <div class="desc">' + 
		     '                <div class="ellipsis"><%=BranchList.get(i).getLOCATION()%></div>' + 
		     '                <div class="jibun ellipsis">Tel: <%=BranchList.get(i).getTEL()%></div>' + 
		     '                <div><a href="branchdetail?BRANCHNO=<%=BranchList.get(i).getBRANCHNO()%>"'+
       ...
       addr: '<%=BranchList.get(i).getLOCATION()%>'
